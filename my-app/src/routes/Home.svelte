<script>
  ...
  async function getGuitar(id) {
    const res = await fetch(
      `https://alexscoelho-guitar-advisor-api-5w546w45c6g9-8000.githubpreview.dev/guitars/${id}`
    );
...
<main>
  ...
  <div class="details-container">
    ...
    {#if guitarValue !== undefined}
      ...
      <img
        src={guitarValue?.image_url}
        alt={guitarValue?.image_url}
        width="200"
        height="200"
      />
    {/if}
    <ReviewForm {reviewBody} {numStars} {guitar} />
  </div>
</main>
